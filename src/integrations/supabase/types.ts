...
export type Database = {
  public: {
    Tables: {
      ...
      ventas: {
        Row: {
          ...
          nc_periodo_modalidad: Database["public"]["Enums"]["modalidad_nc_periodo"] | null;
          nc_periodo_payload_hash: string | null;
          nc_resolucion: Database["public"]["Enums"]["resolucion_nc_periodo"] | null;
    ...
    Enums: {
      ...
      tipo_cliente: "CONSUMIDOR_FINAL" | "RESPONSABLE_INSCRIPTO" | "MONOTRIBUTISTA" | "EXENTO";
      tipo_comprobante:
        | "FACTURA_A"
        | "FACTURA_B"
        | "NOTA_CREDITO"
