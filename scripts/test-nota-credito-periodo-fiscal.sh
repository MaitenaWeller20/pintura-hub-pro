...
VALUES
 ('b2400000-0000-4000-8000-000000000001','CLIENTE NC PERIODO','CONSUMIDOR_FINAL',true,99999999,true,false,NULL),
 ('b2400000-0000-4000-8000-000000000002','CLIENTE NC INACTIVO','RESPONSABLE_INSCRIPTO',true,99999999,false,false,NULL),
 ('b2400000-0000-4000-8000-000000000003','CLIENTE GENERICO','CONSUMIDOR_FINAL',false,NULL,true,true,(SELECT id FROM public.sucursales ORDER BY numero LIMIT 1)),
 ('b2400000-0000-4000-8000-000000000004','CLIENTE RI','RESPONSABLE_INSCRIPTO',true,99999999,true,false,NULL),
 ('b2400000-0000-4000-8000-000000000005','CLIENTE MONO','MONOTRIBUTISTA',true,99999999,true,false,NULL);
