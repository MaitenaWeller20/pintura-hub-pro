-- T13 review: cerco autoritativo de NC/ND en la RPC comercial pública.
-- Copia completa de la definición efectiva de crear_venta; sólo adelanta la
-- lectura de flags y agrega la matriz de notas antes de cualquier mutación.
